...
config="${1:-configs/innovation/cpi_conservative_source_loso_gpu4_7.yaml}"
output_root="${2:-outputs/bench_coe/innovation/cpi_conservative/source_loso_gpu4_7_v1_20260809}"
