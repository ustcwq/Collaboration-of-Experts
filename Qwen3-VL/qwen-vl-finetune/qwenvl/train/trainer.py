...
def flash_attention_forward(
    ...
    **kwargs,
    ...
    if flash_attn_varlen_func is None:
        raise ImportError("flash_attn is required when replacing Qwen-VL attention for flattened training.")
...
def replace_qwen2_vl_attention_class():
    if flash_attn_varlen_func is None:
        raise ImportError("flash_attn is required for data_flatten/data_packing attention replacement.")
    import transformers
